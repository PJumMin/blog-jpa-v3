...
public class TokenTest {
    ...
    public void create_test() {
        ...
        String jwt = JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + 1000)) // 1초 * 60 * 60
    ...
    public void verify_test() {
        ...
        String jwt = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJibG9ndjMiLCJpZCI6MSwiZXhwIjoxNzQ2NzY5NDkxLCJ1c2VybmFtZSI6InNzYXIifQ.NsXRst_jCCyqjPnuteUPzOlQU3O_jewvShnQVLgIG0U\n";
